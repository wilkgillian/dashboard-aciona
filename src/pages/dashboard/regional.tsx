...
export default function Regional() {
  ...
  const { data, tipo, setRegional } = useFilters();
  ...
  useEffect(() => {
    async function getInfos() {
      ...
      if (user) {
        ...
        const response = await loadDashboard(user, tipo, user.id_regional, data);
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm">
                      ...
                      <Text as="strong" color="primary.300">
                        {tipo === "dia" ? moment(dashboard.data.data).format('DD/MM/YYYY') : dashboard.data.data}
                      </Text>
                    </Text>
                  </Box>
                  <ModalFilters />
                  ...
                  {dashboard === null ? (
                    ...
                    <VStack h="30rem" overflowY="auto" spacing="1rem" w="full">
                      {dashboard.data.rankingArrecadacao
                        .sort((a, b) => b.vlrPagamentos! - a.vlrPagamentos!)
                        .filter(item =>
                          item.loja
                            ?.toLowerCase()
